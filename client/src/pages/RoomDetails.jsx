...
const RoomDetails = () => {
    ...
    //check if the Room is avaiblable
    ...
    return  room && (
       <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <form onSubmit={onSubmitHandler} className='flex flex-col md:flex-row items-start md:item-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
