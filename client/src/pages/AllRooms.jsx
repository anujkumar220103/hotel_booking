...
const AllRooms = () => {
    ...
    //function to check if a room matches the seleted price ranges
    ...
    //function ot sort rooms based on the selected sort option 
    const sortRooms = (a, b) =>{
       ...
       <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
         <div>
           <div className='flex flex-col items-start text-left'>
            ...
            <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>take advatage of our limited-time offers and special packages to enhance your stay and create unforgettable memories.</p>
           </div>
